...
contract NFTMarketplace is Ownable, ERC721Holder {
    ...
    function buyItem(uint256 itemID) external payable {
        ...
        //Check payment
        uint256 _itemPrice = listedItemsPrice[itemID];
        require(msg.value == _itemPrice, "Price and paid amount do not watch.");

        address seller = listedItemsPrice(itemID);
    ...
    function updateItemPrice(uint256 itemID, unit256 newPrice) external onlyOwnerOrMarket(itemID) {
